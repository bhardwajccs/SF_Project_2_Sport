...
-- extarct Elements from Innings Array.
...
-- let's see How many Records were Exluded -- No of Loaded minus Total Records
...
DESC TABLE cricket.clean.delivery_clean_tbl;   -- Most of Columns are NULLABLE


Select * from cricket.clean.delivery_clean_tbl;

-- CLEAN Layer Constraints
...
-- Finally we created 3 tables into Clean Layer from JSON Soujrce Data
-- Using these 3 tables we will make dimensiuons and fact tables.
